...
public class GameController13 : MonoBehaviour {
	...
	void Update () {
		...
		case StateGame.Verificando:
		{
				...
				//Resultado
				Result =  A2.value + A4.value; //O Sinal resultante é a somo de todos os outros, como estão com a mesma frequência, é a soma das amplitudes.
		...
		AMP2.text = "Sinal2 =" + A2.value.ToString("f2") + "*Sin(2*PI)";
		AMP3.text = "Sinal3 =" + A3.value.ToString("f2") + "*Sin(PI)";
		AMP4.text = "Sinal4 =" + A4.value.ToString("f2") + "*Sin(2*PI)";
